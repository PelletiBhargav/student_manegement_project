package com.bhargav.student_management.controller;
...
import com.bhargav.student_management.repo.StudentRepo;
...
public class StudentController {
	...
	public ResponseEntity<Student> updateStudents(@PathVariable long id,@RequestBody Student stud) {
		...
		if(student.isPresent()) {
			...
			student.get().setStudentAdedrss(stud.getStudentAdedrss());
